---
name: verify
description: Run linting and tests to verify no regressions. Use when completing a task, checking code quality, or before finishing work.
metadata:
  short-description: Run flake8 + pytest to check for regressions
---
