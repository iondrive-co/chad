---
name: screenshot
description: Capture UI screenshots for visual verification. Use for before/after comparisons, debugging UI issues, or documenting changes. Triggers on "screenshot", "capture UI", "visual check", "before/after".
